...
class GetPackageStatusResponsesData implements ModelInterface, ArrayAccess
{
    ...
    const DECLARED_FAILED = 5;
    const PACKAGE_INFO_LACK = 0;
    const NO_USEFUL_SHIPPING = 4;
    const SELECTED_SHIPPING = 1;
    const APPLIED_TRACKING_CODE = 2;
    const TO_BE_SHIPPED = 3;
    const TO_BE_RECEIVED = 6;
    const DELIVERED = 9;
    const ON_SHIPPING = 8;
    const DELETED = 11;
    const SHIPPED_ERROR = 12;
    const DELIVERY_ERROR = 13;
    const RETURNED = 14;
    const EXCEPTION = 99;
    ...
    {
        return [
            self::DECLARED_FAILED,
            self::PACKAGE_INFO_LACK,
            self::NO_USEFUL_SHIPPING,
            self::SELECTED_SHIPPING,
            self::APPLIED_TRACKING_CODE,
            self::TO_BE_SHIPPED,
            self::TO_BE_RECEIVED,
            self::DELIVERED,
            self::ON_SHIPPING,
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['package_status'], $allowedValues)) {
     ...
     * Sets package_status
     *
     * @param int $package_status åè£¹å½åç¶æï¼æä¸¾ç±»å <a target='_blank' href='/open/development-guide-detail?id=56'>è¯·åèåè£¹ç¶æè¯´æ</a>
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getPackageStatusAllowableValues();
        if (!in_array($package_status, $allowedValues)) {
