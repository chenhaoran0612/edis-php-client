...
class GetActualCostResponsesData implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['charge_mode'] = isset($data['charge_mode']) ? $data['charge_mode'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['actual_weight'] === null) {
            $invalidProperties[] = "'actual_weight' can't be null";
        }
        ...
        if ($this->container['charge_mode'] === null) {
            $invalidProperties[] = "'charge_mode' can't be null";
        }
     ...
     * Sets actual_weight
     *
     * @param float $actual_weight åè£¹å®ééé
     *
     * @return $this
     */
    ...
    {
        return $this->container['charge_mode'];
    }

    /**
     * Sets charge_mode
     *
     * @param string $charge_mode 计费方式
     *
     * @return $this
     */
    public function setChargeMode($charge_mode)
    {
        $this->container['charge_mode'] = $charge_mode;
     ...
     * Sets cost_type
     *
     * @param string $cost_type 扣费类型01=运费   02=国内退货费   03=国内销毁费  04=海关代收代付   05=重量差异  06=重复扣款  07=货物赔偿
     *
     * @return $this
     */
