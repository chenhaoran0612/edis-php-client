...
class DefaultEbayClient
{
     ...
     * 获取带电资质认证信息列表
     *
     * @param  \Swagger\Client\Model\GetBatteryQualListRequest $get_battery_qual_list_request getBatteryQualListRequest (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\GetBatteryQualListResponses
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\GetBatteryQualListResponses, HTTP status code, HTTP response headers (array of strings)
     */
    public function getBatteryQualListWithHttpInfo( $get_battery_qual_list_request)
    {
        $returnType = '\Swagger\Client\Model\GetBatteryQualListResponses';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\GetBatteryQualListResponses',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * 交运单个包裹
     *
     * @param  \Swagger\Client\Model\ConfirmPackageRequest $confirm_package_request confirmPackageRequest (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\ConfirmPackageResponses
     */
    ...
    {
        $returnType = '\Swagger\Client\Model\ConfirmPackageResponses';
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ConfirmPackageResponses, HTTP status code, HTTP response headers (array of strings)
     */
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                    $e->getResponseBody(),
                    '\Swagger\Client\Model\ConfirmPackageResponses',
                    $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * æ¹éæå°é¢å
     *
     * @param  \Swagger\Client\Model\GetLabelListRequest $get_label_list_request getLabelListRequest (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\GetLabelListResponses
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\GetLabelListResponses, HTTP status code, HTTP response headers (array of strings)
     */
    public function getLabelListWithHttpInfo($get_label_list_request)
    {
        $returnType = '\Swagger\Client\Model\GetLabelListResponses';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                    $e->getResponseBody(),
                    '\Swagger\Client\Model\GetLabelListResponses',
                    $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
